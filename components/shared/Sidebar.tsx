        ...
        <div className="fixed inset-0 lg:hidden" style={{ zIndex: 100000 }}>
          ...
          <div className="absolute inset-y-0 left-0 w-72 bg-white flex flex-col shadow-2xl">
            <div className="flex items-center gap-2 px-6 h-16 border-b border-[#E2E8F0]">
              ...
              <button onClick={closeSidebar} aria-label="Close navigation menu" className="p-2 min-w-[44px] min-h-[44px] flex items-center justify-center text-[#64748B] hover:text-[#0F172A]">
                <X className="w-6 h-6" />
              </button>
            </div>
